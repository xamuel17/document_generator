                        ...
                        var o = (s.loading = pdfjsLib.getDocument(
                            ...
                            s.options.docParameters : {
                                ...
                                rangeChunkSize: isNaN(s.options.rangeChunkSize) ?
                                    524288 : s.options.rangeChunkSize,
                                cMapUrl: n.cMapUrl,
                                cMapPacked: true,
        ...
        e.prototype = {
            ...
            tween: function(e) {
                ...
                var c,
                    ...
                    h = 0
                var p = (i.end =
                    i && i.animateToReset == true ? { x: a ? i.parent.fullWidth : 0, y: l } : { x: a ? 0 : i.parent.fullWidth, y: l })
                i.ease = i.isHard ?
                ...
                if (i.isHard == true) {
                    ...
                    if (e == null) {
                        c = i.init =
                            i && i.animateToReset == true ? { x: a ? 0 : i.parent.fullWidth, y: 0 } : { x: a ? i.parent.fullWidth : 0, y: 0 }
                ...
                s(function() {
                    ...
                    a.contentProvider = new Y(
                        ...
                        function(n) {
                            ...
                            a.target = o = a.stage.target = new MOCKUP.Book(
                                R(a.options, r),
                                a.stage
                            )
                            a.extendtarget()
